...
const t = {
  de: {
    ...
    about_whoami: 'Angehender Penetration Tester mit praktischem Ansatz und breitem technischem Fundament. Seit 2020 aktiv in privaten Bug-Bounty-Programmen, regelmäßig auf HackTheBox und im eigenen Security Lab. Ausgebildeter Mechatroniker mit OT/ICS-Hintergrund (Siemens S7, SCADA).',
    ...
    proj_bb_desc:    'Aktive Teilnahme an privaten / invite-only Programmen via HackerOne und Bugcrowd seit 2020. Details unter NDA.',
  ...
  en: {
    ...
    about_whoami: 'Aspiring penetration tester with a hands-on approach and broad technical foundation. Actively participating in private bug bounty programs since 2020, regularly working on HackTheBox and running my own security lab. Trained mechatronics engineer with OT/ICS background (Siemens S7, SCADA).',
    about_focus:  'Bug Bounty · HackTheBox · Web & API Testing · Red Team · OT/ICS Security',
    skills_title: 'Skills',
    sk_offensive: 'Offensive Security',
    sk_tools:     'Tools',
    ...
    proj_bb_title:   'Bug Bounty',
    proj_bb_desc:    'Active participation in private / invite-only programs via HackerOne and Bugcrowd since 2020. Details under NDA.',
